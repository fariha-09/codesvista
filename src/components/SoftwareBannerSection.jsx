...
import { FaMobileScreen,FaClock } from "react-icons/fa6";
import { MdEngineering } from "react-icons/md";
import Typewriter from "typewriter-effect";

export default function SoftwareBannerSection() {
  const stats = [
    {
      label: "25+",
      sub: "Apps Developed",
        ...
        <div className="container mx-auto px-10 relative z-10 flex flex-col lg:flex-row justify-between h-full lg:py-4">
          ...
          <div className="w-full lg:w-1/2 space-y-6  ">
            ...
            <p className="text-[#F1F3F4] text-[18px] font-normal max-w-lg leading-relaxed">
                Engineering custom, scalable software solutions to streamline your operations, solve complex challenges, and improve efficiency.
            </p>
           ...
           <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                >
                  <FaCode size={15} className="text-[#3B82F6]" />
                </motion.div>
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative z-10"
                >
                  <FaMobileScreen size={15} className="text-[#FF6800]" />
                </motion.div>

                <span className="relative z-10"> Mobile App Development</span>
              </motion.span>
              <motion.span
                initial="initial"
                whileHover="hover"
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative z-10"
                >
                  <FaShoppingCart size={15} className="text-[#4ADE80]" />{" "}
                </motion.div>

                <span className="relative z-10"> Ecommerce development</span>
              </motion.span>
            </div>
