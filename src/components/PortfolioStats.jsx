                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {stats.map((stat, index) => {
                        ...
                        return (
                            <div 
                                key={index} 
                                className="flex items-center p-6 bg-[#F1F3F4] rounded-[12px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 transition-transform hover:scale-105"
                            >
                                {/* Icon Container */}
                                <div className={`${stat.color} w-12 h-12 flex items-center justify-center rounded-lg mr-4 flex-shrink-0`}>
