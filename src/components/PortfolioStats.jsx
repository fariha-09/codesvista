                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 md:gap-6 gap-4">
                    {stats.map((stat, index) => {
                        ...
                        return (
                            <div 
                                key={index} 
                                className="flex items-center p-2  md:p-6 bg-[#F1F3F4] rounded-[12px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 transition-transform md:hover:scale-105"
                            >
                                {/* Icon Container */}
