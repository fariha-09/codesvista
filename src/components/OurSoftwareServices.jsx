          ...
          {softwareOffers.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-[20px] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col items-center text-center group transition-all duration-300 overflow-hidden"
              >
                ...
                {/* Icon Container */}
                <div className="relative z-10 w-20 h-20 bg-[#F1F3F4] rounded-2xl flex items-center justify-center mb-8 transition-all duration-300 group-hover:bg-[#0FC8CA] group-hover:shadow-lg">
                  <Icon className="text-3xl text-[#0FC8CA] group-hover:text-white transition-colors duration-300" />
                </div>

                {/* Content Area */}
                <div className="relative z-10 flex flex-col items-center flex-grow">
                  <h3 className="text-[#0FC8CA] text-2xl font-bold mb-3 tracking-tight">
                    {item.title}
                  </h3>
                  <p className="text-[#4C448080] text-sm leading-relaxed mb-6">
                    {item.desc}
                  </p>
