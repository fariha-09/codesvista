...
export default function SeoFAQs() {
  ...
  const faqs = [
    {
      question: "How long does SEO services take to show results?",
      answer:
    ...
    {
      question: "Do you guarrantee first-page rankings?",
      answer:
        "While we strive to achieve top rankings, no reputable SEO provider can guarantee specific positions due to the dynamic nature of search engines.",
    },
    {
      question: "What's included in your Content Writing services?",
      answer:
        "Our Content Writing services include SEO-optimized articles, blog posts, website copy, and other content types tailored to your audience and goals.",
    },
    {
      question: "Can you help with local SEO?",
      answer:
        "Yes, we offer local SEO services to help your business rank higher in local search results and attract nearby customers.",
    },
  ];
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[1400px] flex justify-center overflow-hidden bg-white/[98%] py-10 md:px-20">
        <div className="bg-[#FFFFFF] w-[98%] justify-center md:py-10">
          {/* Header Content */}
