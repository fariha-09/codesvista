        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          {categories.map((cat, index) => {
            ...
            return (
              ...
              >
                {/* Icon Container */}
                <div className={`${cat.bgColor} w-16 h-16 rounded-[8px] flex items-center justify-center mb-6 shadow-lg shadow-black/10 transition-transform group-hover:scale-110`}>
