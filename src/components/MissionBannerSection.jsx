        ...
        <div className="container mx-auto px-6 md:px-10 relative z-10 flex flex-col lg:flex-row justify-between h-full py-2 lg:py-4 gap-10 lg:gap-0">
          ...
          <div className="w-full lg:w-1/2 space-y-2 lg:space-y-4 flex flex-col justify-center">
            ...
            <p className="text-[#F1F3F4] text-base md:text-[18px] font-normal max-w-xl leading-relaxed ">
              ...
              technology solutions that drive growth, efficiency, and long-term
              digital success.m{" "}
            </p>
          ...
          <div className="w-full lg:w-1/2 flex flex-col md:flex-row items-center justify-center lg:justify-end gap-6">
            {/* Stats Card */}
            <div className="bg-white/20 relative mt-0 md:mt-0  backdrop-blur-xl border border-white/30 p-6 md:p-8 rounded-[30px] md:rounded-[40px] shadow-2xl w-full max-w-md">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-white text-xs font-semibold opacity-90 uppercase tracking-widest">
                  Company Bio
                </span>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-white  font-semibold text-sm group-hover:text-[#0FC8CA] transition-colors">
                          {stat.sub}
                        </p>
                      </div>
                    </div>
