    ...
    <nav className="bg-white backdrop-blur-md sticky top-0 z-50 border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/getquote" // Replace with the actual path to your GetFreeQuote component
              className="hidden sm:flex items-center gap-2 bg-[#AC1B9E] text-[#F1F3F4] px-5 py-2 rounded-full font-semibold hover:bg-[#8e1682] transition-all shadow-md active:scale-95"
            >
              <Quote size={18} />
      ...
      {isOpen && (
        <div className="lg:hidden bg-white border-t border-gray-100 p-4 space-y-4 shadow-lg">
          ...
          <button className="w-full flex items-center justify-center gap-2 bg-[#AC1B9E] text-[#FFFFFF] px-5 py-3 rounded-xl font-semibold">
            <Quote size={18} />
            Get Quote
          </button>
        </div>
