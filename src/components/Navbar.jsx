      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link to="/" className="text-[#4C4480] font-medium hover:text-[#AC1B9E] transition-colors">Home</Link>
            <Link to="/about" className="text-[#4C4480] font-medium hover:text-[#AC1B9E] transition-colors">About Us</Link>
            ...
            >
              <button className="flex items-center gap-1 text-[#4C4480] font-medium hover:[#AC1B9E] focus:outline-none">
                Services <ChevronDown size={16} className={`transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
                ...
                <div className="absolute left-0 mt-0 w-64 bg-white shadow-xl border border-gray-100 rounded-xl overflow-hidden z-50">
                  <div className="py-2">
                    {serviceLinks.map((service) => (
                      ...
                      >
                        <span className="text-gray-400 hover:text-[#AC1B9E] text-xl">{service.icon}</span>
                        {service.name}
                      </Link>
                    ))}
                  </div>
            ...
            <Link to="/portfolio" className="text-[#4C4480] font-medium hover:text-[#AC1B9E] transition-colors">Portfolio</Link>
            <Link to="/blog" className="text-[#4C4480] font-medium hover:text-[#AC1B9E] transition-colors">Blog</Link>
            <Link to="/contact" className="text-[#4C4480] font-medium hover:text-[#AC1B9E] transition-colors">Contact</Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setIsOpen(!isOpen)} className="lg:hidden p-2 text-[#4C4480]">
