...
export default function AppTechnologies() {
  ...
  return (
    ...
    >
      <div className="relative w-full  bg-white/[98%] p-10 md:p-20">
        {/* Header Content */}
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10 mb-20">
          ...
          <p className="text-[#4C448080]/50 text-lg md:text-[20px]  mx-auto leading-relaxed">
            We specialize in <strong>Flutter</strong> to deliver fast,
            cost-effective, and high-performance apps for all mobile platforms.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#4C448080] leading-relaxed text-sm md:text-base">
                Using Flutter's single codebase, we ensure consistent UI across
                platforms with lower maintenance costs and native-level
                performance.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#4C448080] leading-relaxed text-sm md:text-base">
                Our mobile backends are built with scalable architecture to
                handle real-time data sync, secure authentication, and cloud
                integration.
              </p>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
