...
import { FaShoppingCart, FaMobileAlt, FaCode, FaRocket, FaCodeBranch, FaStar } from "react-icons/fa";
...
export default function AppDevelopmentBannerSection() {
  ...
  return (
    <section className="relative bg-[#0fc8ca] min-h-[88vh] w-full flex justify-center lg:px-10 font-sans overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-10 relative z-10 flex flex-col lg:flex-row justify-between h-full py-2 lg:py-4 gap-10 lg:gap-0">
        ...
        <div className="w-full lg:w-1/2 space-y-2 lg:space-y-4 flex flex-col justify-center">
          <div className="inline-flex self-start items-center gap-2 bg-white/20 px-4 py-1.5 rounded-full backdrop-blur-md border border-white/20 hover:bg-white hover:text-black transition-all cursor-default group">
