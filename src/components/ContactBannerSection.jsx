  ...
  return (
    <section className="relative bg-[#0fc8ca] min-h-[88vh] w-full flex justify-center font-sans overflow-hidden">
      <div className="relative w-full max-w-[1500px] flex flex-col justify-center">
        ...
        {/* MAIN CONTENT */}
        <div className="container mx-auto px-6 md:px-10 py-12 lg:py-4 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-5">
          ...
          <div className="w-full lg:w-1/2 space-y-8 md:space-y-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight min-h-[80px]">
              <Typewriter
                options={{
                  strings: [
                    "Let's Connect!",
            ...
            <p className="text-[#F1F3F4] text-base md:text-[18px] font-normal max-w-xl leading-relaxed">
              ...
              consultation and discover how we can help transform your business with technology.
            </p>

            {/* Feature Badges */}
            <div className="flex flex-wrap gap-3">
              {[
                { label: "24/7 Support", icon: FaTags, color: "text-[#3B82F6]" },
                { label: "Free Consultation", icon: FaPencilRuler, color: "text-[#FF6800]" },
                { label: "Quick Response", icon: FaLightbulb, color: "text-[#4ADE80]" },
              ].map((item, index) => (
                <motion.span
                  key={index}
                  initial="initial"
