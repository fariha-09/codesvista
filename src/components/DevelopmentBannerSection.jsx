...
import { MdOutlineWeb, MdTimer, MdStar } from "react-icons/md";
    ...
    <section className="relative bg-[#0fc8ca] min-h-screen lg:min-h-[88vh] w-full flex justify-center lg:px-10 font-sans overflow-hidden">
      ...
      <div className="relative w-full max-w-[1500px] h-full lg:h-[88vh] overflow-hidden lg:shadow-2xl">
        ...
        <div className="container mx-auto px-6 md:px-10 relative z-10 flex flex-col lg:flex-row justify-between h-full py-2 lg:py-4 gap-12 lg:gap-0">
          ...
          {/* LEFT COLUMN */}
          <div className="w-full lg:w-1/2 space-y-2 md:space-y-4 lg:space-y-4 flex flex-col justify-center">
            <div className="inline-flex self-start items-center gap-2 text-white hover:text-black bg-white/20 px-4 py-1.5 rounded-full backdrop-blur-md border border-white/20 hover:bg-[#F1F3F4] transition-all cursor-default">
              ...
              <span className="font-medium text-[14px]">Web Development</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-[1.1] min-h-[80px] md:min-h-auto">
              <Typewriter
                options={{
                  strings: [
                    "Professional Web <br /> Development Services",
                    "Custom Business <br /> Solutions",
                    "Modern User <br /> Experiences"
                  ],
                  autoStart: true,
                  loop: true,
                  deleteSpeed: 50,
            ...
            <p className="text-[#F1F3F4] text-base md:text-[18px] font-normal max-w-xl leading-relaxed">
              Transform your business with custom websites and web applications built using modern technologies and best practices for optimal performance and user experience.
            </p>
