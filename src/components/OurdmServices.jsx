    ...
    <section
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 relative z-10">
          {offers.map((item, index) => {
            // ✅ Correctly defining the component inside the loop
            ...
            return (
              <motion.div
                ...
                initial="initial"
                whileHover="hover"
                className="relative bg-white p-10 rounded-[30px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] flex flex-col items-center text-center overflow-hidden border border-white group cursor-pointer"
              >
                ...
                <div className="relative z-10 w-20 h-20 bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] flex items-center justify-center mb-8 transition-transform duration-300 group-hover:-translate-y-2">
                  <IconComponent className="text-4xl text-[#0FC8CA]" />
                </div>

                {/* Text Content */}
                <div className="relative z-10">
                  <h3 className="text-[#0E9C9D] font-bold text-[22px] mb-4 group-hover:text-[#4C4480] transition-colors">
                    {item.title}
                  </h3>
