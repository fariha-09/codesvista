...
import blogcode from "../assets/blogcode.jpg";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              {sideArticles.map((article, index) => (
                <div
                  key={index}
                  className="bg-white p-4 rounded-[24px] shadow-sm border border-gray-100 flex items-center gap-5 hover:shadow-md transition-shadow group"
                >
                  ...
                  <div className="flex flex-col gap-1">
                    <span
                      className={`${article.tagStyles} text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-md w-fit`}
                    >
                      {article.tag}
                    </span>
                    ...
                    <div className="mt-1">
                      <span className="text-[#2B2C3499]/60 text-[12px]">
